...
function setBack(){
   ...
   <button onclick="findChannels()" onmouseover="iconFixerOn('.hover3')" onmouseout="iconFixerOut('.hover3')" id="b3" class="bMain b3"><img src="images/globe.svg" class="hover3"><a class="text">Chat with your class</a></button>
   ...
   <button onclick="findChannels()" onmouseover="iconFixerOn('.hover3')" onmouseout="iconFixerOut('.hover3')" id="b3" class="rMain b3"><img src="images/globe.svg" class="hover3"><a class="text">Class chat</a></button>
